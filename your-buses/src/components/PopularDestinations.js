      ...
      <div className="container text-center">
        ...
        <div className="col">
          ...
          <div className="card-body">
             <h5 className="card-title" style={{color: "blue"}}>Mombasa</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Nairobi</h5>
        ...
        <div className="col">
          <div className="card" style={{width: '18rem'}}>
            <img src="https://pbs.twimg.com/media/EJos7clXUAIpEQ-.jpg" className="card-img-top" alt="..."/>
        <div className="card-body">
            <h5 className="card-title" style={{color: "blue"}}>Isiolo</h5>
            <p className="card-text">The Nothern gem with Dubai-like hypes of the sand dunes and one of the best tarmaced roads and best views.</p>
        </div>
        </div>
        </div>
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Kericho</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
             <img src="https://i0.wp.com/www.safari254.com/wp-content/uploads/2018/07/Kisumu_view-from-Kisumu-Beach-Resort-night.jpg" className="card-img-top" alt="..."/>
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Kisumu Dala</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Lamu</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Nakuru</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Eldoret</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Kisii</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Migori</h5>
        ...
        <div className="col">
           <div className="card" style={{width: '18rem'}}>
            ...
            <div className="card-body">
              <h5 className="card-title" style={{color: "blue"}}>Nyeri</h5>
